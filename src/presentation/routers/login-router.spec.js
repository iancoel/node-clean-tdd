...
const { MissingParamError, InvalidParamError, UnauthorizedError, ServerError } = require('../helpers/errors')
...
describe('Login Router', () => {
  ...
  test('Should call AuthUseCase with the corrects params', async () => {
